...
function Reservationslist() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      //TODO PRIMER ITEM
      const newSelected = reservations.map((n) => n.bookingDate);
                    ...
                    >
                      ...
                      >
                        <Typography variant="subtitle2" noWrap>
                          {moment(
                            new Date(row.bookingDate.toDate().toUTCString())
                          ).format("DD/MM/YYYY")}
                        </Typography>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        {moment(
                          new Date(row.startDate.toDate()).toUTCString()
                        ).format("DD/MM/YYYY")}
                      </TableCell>
                      <TableCell>
                        {moment(
                          new Date(row.endDate.toDate()).toUTCString()
                        ).format("DD/MM/YYYY")}
                      </TableCell>
                    </TableRow>
                  );
